...
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"WHAT":6,"CREW":7,"OFFICER":8,"COUNT":9,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"CREW",8:"OFFICER",9:"COUNT"},
productions_: [0,[3,2],[6,0],[6,1],[6,1],[4,2]],
...
case 1:return($$[$0-1]);
break;
case 5:var query = '{"command":"count","query":{"' + solveField($$[$0]) + '":"' + $$[$0] + '"}}';this.$ = query;
break;
}
},
table: [{3:1,4:2,9:[1,3]},{1:[3]},{5:[1,4]},{5:[2,2],6:5,7:[1,6],8:[1,7]},{1:[2,1]},{5:[2,5]},{5:[2,3]},{5:[2,4]}],
defaultActions: {4:[2,1],5:[2,5],6:[2,3],7:[2,4]},
...
lexer.rules = [/^(?:\s+)/,/^(?:count\b)/,/^(?:crew\b)/,/^(?:officer\b)/,/^(?:$)/];
